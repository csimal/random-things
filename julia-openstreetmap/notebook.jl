...
# ╔═╡ 43893d52-09aa-11eb-14a0-d9df55c7c16a
begin
	using Random
	using Parameters
...
# ╔═╡ 71d95190-09aa-11eb-1fa9-4d13c37e45ad
pwd()

# ╔═╡ 20164f50-09ac-11eb-342d-777cb0a36057
#cd(raw"C:\Users\cedric\Dropbox\Programming\Julia\openstreetmap")

# ╔═╡ 46f183b0-09ac-11eb-2738-4f9a296c6e99
m = get_map_data("map.osm", use_cache=false, trim_to_connected_graph=true );

# ╔═╡ 7e10b0a0-09ac-11eb-3b0c-7da1f27afeac
begin
...
# ╔═╡ c486de10-09ac-11eb-150f-b95736084d5e
begin
	fm = flm.Map(tiles="CartoDB positron")
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "064d3a9569a95fddf9ddd9c40e9223dc7de45f14"
